...
describe("Detailed Table snapshot", () => {
  it('should render correctly in "debug" mode', () => {
    ...
    const component: any = shallow(<BookResults {...props} />);
    expect(component).toMatchSnapshot();
    expect(component.find("[name='btn-wishlist']").getElements()).toHaveLength(
      2
    );
    component.find("[name='btn-wishlist']").getElements()[0].props.onClick();
    expect(props.addToWishList).toHaveBeenCalledTimes(1);
